    ...
    <div className="container">
        ...
        <div className="registration">
            <div className="registration-media">
                ...
                <p className="registration-signup">Already have an Account? <Link to="#">Login</Link></p>
            </div>
            <div className="registration-wrapper">
                ...
                <div className="registration-input-wrapper">
                    <div className="registration-input-organization">
                        <div className="input">
                            <input type="radio" id="registration-individual" name="registration-type" value="individual" />
                            <label for="registration-type">Individual</label>
                        </div>
                        <div className="input">
                            <input checked type="radio" id="registration-organization" name="registration-type" value="organization" />
                            <label for="registration-type">Institute/Organization</label>
                        </div>
                    </div>
                    <div className="registration-input">
                        <label for="first-name">Name <span className="required">*</span></label>
                        <img className="icon" src={accountvector} alt="" />
                        <input className="input" type="text" name="first-name" id="first-name" placeholder="Type your full name here" />
                    </div>
                    <div className="registration-input">
                        <label for="institute-type">Type of Institution/Organization <span className="required">*</span></label>
                        <img className="icon" src={officebuildingvector} alt="" />
                        <select className="input" name="institute-type" id="institute-type">
                    ...
                    <div className="registration-input">
                        <label for="institute-select">Institution/Organization <span className="required">*</span></label>
                        <img className="icon" src={officebuildingvector} alt="" />
                        <select className="input" name="institute-select" id="institute-select">
                            <option value="none" selected disabled>Choose one</option>
                    ...
                    <div className="registration-input">
                        <label for="mobile-number">Mobile Number<span className="required">*</span></label>
                        <img className="icon" src={mobilevector} alt="" />
                        <input className="input" type="tel" name="mobile-number" id="mobile-number" placeholder="Type your 11-digit Mobile Phone Number" />
                    </div>
                    <div className="registration-input">
                        <label for="email-address">Email Address</label>
                        <img className="icon" src={mailvector} alt="" />
                        <input className="input" type="tel" name="email-address" id="email-address" placeholder="Type your email address" />
                    </div>
                    <div className="registration-input-declaration">
                        <input type="checkbox" id="declaration" name="declaration" value="1" />
                        <label for="declaration"> I agree to the <Link to="#">Terms of Use</Link> and <Link to="#">Privacy Policy</Link></label>
                    </div>
